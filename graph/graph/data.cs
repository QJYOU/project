...
namespace graph
{
    class data
    {
        ...
        public void insert_account(string accoun, string password, int gender, float height, float weight, float age, int lifestyle, float daily_calories)
        {
        ...
        private string path = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\ee258\Desktop\groupProject\project\graph\graph\dataserver.mdf;Integrated Security=True";
